...
@Configuration
@Aspect
@ComponentScan({"com.smartapps.smartreferencedata.shared.*",
	"com.smartapps.smartreferencedata.jpa.*",
	"com.smartapps.smartreferencedata.web.*",
	"com.smartapps.smartlib.*"})
@EntityScan("com.smartapps.smartreferencedata.jpa.entities")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = { "com.smartapps.smartreferencedata.jpa.repository" })
